             ...
             <div className={formStyle.Form_box_input}>
              ...
              <div className={formStyle.Form_box_input}>
                 ...
                 <p className={formStyle.upload_box_input_para}>
                    Ciscrypt will include a link to this URL on this item's detailspage,
                ...
                <div className={formStyle.Form_box_input}>
                    ...
                    <p>
                        the description will be included on the item's page underneath its image.
                ...
                <div className={formStyle.Form_box_input}>
                    ...
                    <p className={Style.upload_box_input_para}>
                        Choose and exiting colloection or create a new one
                    </p>
                        ...
                        <div className={formStyle.Form_box_input}>
                            ...
                            <div className={formStyle.Form_box_input_box}>
                                ...
                                <input 
                                   type="text"
                                   placeholder="20%"  
                                   onChange={()=> setRoyalties(e.target.value)}
                                />
                            </div>                
                        </div>
                        <div className={formStyle.Form_box_input}>
